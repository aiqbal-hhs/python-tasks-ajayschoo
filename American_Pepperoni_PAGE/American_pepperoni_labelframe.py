...
storing_current_toppings = ['Mozzarella Cheese', 'Pepperoni']
...
topping_background_frame = Frame(expanding_pages.american_pepperion_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
