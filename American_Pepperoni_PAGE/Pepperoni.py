...
# Removing pepperoni cheese from current topping list if want to
def remove_pepperoni():
    pepperoni_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Pepperoni")
    pepperoni_add_on.topping_button['state'] = NORMAL
    pepperoni_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting pepperoni cheese into current topping
def pepperoni_becomes_current():
    global pepperoni_current
    intro_pages.storing_current_toppings.append('Pepperoni')
    pepperoni_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Pepperoni.png",
    "Pepperoni\n\n\n", remove_pepperoni,0,0)
    pepperoni_add_on.topping_button['state'] = DISABLED
    pepperoni_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    pepperoni_current.mini_labelframe.grid(row=pepperoni_row, column=pepperoni_placement)

# Current toppings for simply cheese
pepperoni_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Pepperoni.png","Pepperoni\n\n\n",
remove_pepperoni, 1,0)

# pepperoni cheese to add_on toppings
pepperoni_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Pepperoni.png"
,"Pepperoni\n\n\n", 3,6, pepperoni_becomes_current)
pepperoni_add_on.topping_button['state'] = DISABLED
pepperoni_add_on.add_on_topping_name.configure(fg = '#DADADA')
...
from American_Pepperoni_PAGE import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce