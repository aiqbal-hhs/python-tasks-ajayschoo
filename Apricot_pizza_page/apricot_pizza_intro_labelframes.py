...
storing_current_toppings = ['Mozzarella Cheese', 'Seasoned Chicken', 'Capsicum', 'Red Onions']
...
topping_background_frame = Frame(expanding_pages.apricot_chicken_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
