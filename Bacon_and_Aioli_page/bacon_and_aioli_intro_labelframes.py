...
storing_current_toppings = ['Mozzarella Cheese', 'Baby Spinach', 'Gralic Base Sauce Swirl', 'Rasher Bacon', 'Red Onions', 'Seasoned Chicken']
...
topping_background_frame = Frame(expanding_pages.chicken_bacon_alioli_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
