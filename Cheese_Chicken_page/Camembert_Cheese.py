...
# Removing camembert_cheese cheese from current topping list if want to
def remove_camembert_cheese():
    camembert_cheese_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Camambert Cheese")
    camembert_cheese_add_on.topping_button['state'] = NORMAL
    camembert_cheese_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting camembert_cheese cheese into current topping
def camembert_cheese_becomes_current():
    global camembert_cheese_current
    intro_pages.storing_current_toppings.append('Camambert Cheese')
    camembert_cheese_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Camembert Cheese.png",
    "Camembert\nCheese\n\n", remove_camembert_cheese, 0,0)
    camembert_cheese_add_on.topping_button['state'] = DISABLED
    camembert_cheese_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    camembert_cheese_current.mini_labelframe.grid(row=camembert_cheese_row, column=camembert_cheese_placement)

# Current toppings for simply cheese
camembert_cheese_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Camembert Cheese.png","Camembert\nCheese\n\n",
remove_camembert_cheese, 2,0)

# camembert_cheese cheese to add_on toppings
camembert_cheese_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Camembert Cheese.png"
,"Camembert\nCheese\n\n", 1,2, camembert_cheese_becomes_current)
camembert_cheese_add_on.topping_button['state'] = DISABLED
camembert_cheese_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Cheese_Chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
