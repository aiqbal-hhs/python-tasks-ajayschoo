...
from Cheese_Chicken_page import chicken_cheese_intro_labelframes as intro_pages


# Removing hollandaise_sauce_swirl cheese from current topping list if want to
def remove_hollandaise_sauce_swirl():
    hollandaise_sauce_swirl_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Hollandaise Sauce Swirl")
    hollandaise_sauce_swirl_add_on.topping_button['state'] = NORMAL
    hollandaise_sauce_swirl_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting hollandaise_sauce_swirl cheese into current topping
def hollandaise_sauce_swirl_becomes_current():
    global hollandaise_sauce_swirl_current
    intro_pages.storing_current_toppings.append('Hollandaise Sauce Swirl')
    hollandaise_sauce_swirl_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Hollandaise Sauce Swirl.png",
    "Hollandaise\nsauce\nswirl\n", remove_hollandaise_sauce_swirl,0,0)
    hollandaise_sauce_swirl_add_on.topping_button['state'] = DISABLED
    hollandaise_sauce_swirl_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    hollandaise_sauce_swirl_current.mini_labelframe.grid(row=hollandaise_sauce_swirl_row, column=hollandaise_sauce_swirl_placement)

# Current toppings for simply cheese
hollandaise_sauce_swirl_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Hollandaise Sauce Swirl.png","Hollandaise\nsauce\nswirl\n",
remove_hollandaise_sauce_swirl, 4,0)

# hollandaise_sauce_swirl cheese to add_on toppings
hollandaise_sauce_swirl_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Hollandaise Sauce Swirl.png"
,"Hollandaise\nsauce\nswirl\n", 2,6, hollandaise_sauce_swirl_becomes_current)
hollandaise_sauce_swirl_add_on.topping_button['state'] = DISABLED
hollandaise_sauce_swirl_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Cheese_Chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies,Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce