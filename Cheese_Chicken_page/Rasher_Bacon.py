...
# Removing rasher_bacon cheese from current topping list if want to
def remove_rasher_bacon():
    rasher_bacon_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Rasher Bacon")
    rasher_bacon_add_on.topping_button['state'] = NORMAL
    rasher_bacon_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting rasher_bacon cheese into current topping
def rasher_bacon_becomes_current():
    global rasher_bacon_current
    intro_pages.storing_current_toppings.append('Rasher Bacon')
    rasher_bacon_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Rasher_Bacon.png",
    "Rasher\nBacon\n\n", remove_rasher_bacon,0,0)
    rasher_bacon_add_on.topping_button['state'] = DISABLED
    rasher_bacon_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    rasher_bacon_current.mini_labelframe.grid(row=rasher_bacon_row, column=rasher_bacon_placement)

# Current toppings for simply cheese
rasher_bacon_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Rasher_Bacon.png","Rasher\nBacon\n\n",
remove_rasher_bacon, 5,0)

# rasher_bacon cheese to add_on toppings
rasher_bacon_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Rasher_Bacon.png"
,"Rasher\nBacon\n\n", 4,3, rasher_bacon_becomes_current)
rasher_bacon_add_on.topping_button['state'] = DISABLED
rasher_bacon_add_on.add_on_topping_name.configure(fg = '#DADADA')
...
from Cheese_Chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce