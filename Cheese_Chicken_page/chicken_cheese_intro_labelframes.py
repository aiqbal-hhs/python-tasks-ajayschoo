...
storing_current_toppings = ['Mozzarella Cheese', 'Baby Spinach', 'Camambert Cheese', 'Fresh Tomatos', 'Hollandaise Sauce Swirl', 'Rasher Bacon', 'Red Onions', 'Seasoned Chicken']
...
topping_background_frame = Frame(expanding_pages.chicken_and_cheese_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
