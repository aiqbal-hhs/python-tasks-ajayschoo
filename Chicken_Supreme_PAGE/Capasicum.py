...
# Removing capsicum cheese from current topping list if want to
def remove_capsicum():
    capsicum_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Capsicum")
    capsicum_add_on.topping_button['state'] = NORMAL
    capsicum_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting capsicum cheese into current topping
def capsicum_becomes_current():
    global capsicum_current
    intro_pages.storing_current_toppings.append('Capsicum')
    capsicum_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\cpasicum.png",
    "Capsicum\n\n\n", remove_capsicum,0,0)
    capsicum_add_on.topping_button['state'] = DISABLED
    capsicum_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    capsicum_current.mini_labelframe.grid(row=capsicum_row, column=capsicum_placement)

# Current toppings for Chicken Supreme
capsicum_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\cpasicum.png","Capsicum\n\n\n",
remove_capsicum, 5,0)

# capsicum cheese to add_on toppings
capsicum_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\cpasicum.png"
,"Capsicum\n\n\n", 1,3, capsicum_becomes_current)
capsicum_add_on.topping_button['state'] = DISABLED
capsicum_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Chicken_Supreme_PAGE import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
