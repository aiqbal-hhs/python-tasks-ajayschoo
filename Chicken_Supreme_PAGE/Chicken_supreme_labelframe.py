...
storing_current_toppings = ['Mozzarella Cheese', 'Capsicum', 'Mushroom', 'Red Onions', 'Pineapple', 'Spring Onions']
...
topping_background_frame = Frame(expanding_pages.chicken_supreme_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
