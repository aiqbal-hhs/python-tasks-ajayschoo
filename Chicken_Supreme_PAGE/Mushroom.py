...
# Removing mushroom cheese from current topping list if want to
def remove_mushroom():
    mushroom_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Mushroom")
    mushroom_add_on.topping_button['state'] = NORMAL
    mushroom_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting mushroom cheese into current topping
def mushroom_becomes_current():
    global mushroom_current
    intro_pages.storing_current_toppings.append('Mushroom')
    mushroom_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Mushroom.png",
    "Mushroom\n\n\n", remove_mushroom,0,0)
    mushroom_add_on.topping_button['state'] = DISABLED
    mushroom_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    mushroom_current.mini_labelframe.grid(row=mushroom_row, column=mushroom_placement)

# Current toppings for Chicken Supreme
mushroom_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Mushroom.png","Mushroom\n\n\n",
remove_mushroom, 4,0)

# mushroom cheese to add_on toppings
mushroom_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Mushroom.png"
,"Mushroom\n\n\n", 3,2, mushroom_becomes_current)
mushroom_add_on.topping_button['state'] = DISABLED
mushroom_add_on.add_on_topping_name.configure(fg = '#DADADA')
...
from Chicken_Supreme_PAGE import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce