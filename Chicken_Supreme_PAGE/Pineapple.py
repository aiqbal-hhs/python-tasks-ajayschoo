...
# Removing pineapple cheese from current topping list if want to
def remove_pineapple():
    pineapple_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Pineapple")
    pineapple_add_on.topping_button['state'] = NORMAL
    pineapple_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting pineapple cheese into current topping
def pineapple_becomes_current():
    global pineapple_current
    intro_pages.storing_current_toppings.append('Pineapple')
    pineapple_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\pineapple.png",
    "Pineapple\n\n\n", remove_pineapple,0,0)
    pineapple_add_on.topping_button['state'] = DISABLED
    pineapple_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    pineapple_current.mini_labelframe.grid(row=pineapple_row, column=pineapple_placement)

# Current toppings for Chicken Supreme
pineapple_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\pineapple.png","Pineapple\n\n\n",
remove_pineapple, 2,0)

# pineapple cheese to add_on toppings
pineapple_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\pineapple.png"
,"Pineapple\n\n\n", 4,0, pineapple_becomes_current)
pineapple_add_on.topping_button['state'] = DISABLED
pineapple_add_on.add_on_topping_name.configure(fg = '#DADADA')
...
from Chicken_Supreme_PAGE import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce