...
# Removing spring_onions cheese from current topping list if want to
def remove_spring_onions():
    spring_onions_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Spring Onions")
    spring_onions_add_on.topping_button['state'] = NORMAL
    spring_onions_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting spring_onions cheese into current topping
def spring_onions_becomes_current():
    global spring_onions_current
    intro_pages.storing_current_toppings.append('Spring Onions')
    spring_onions_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Spring_onion.png",
    "Spring\nOnions\n\n", remove_spring_onions,0,0)
    spring_onions_add_on.topping_button['state'] = DISABLED
    spring_onions_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    spring_onions_current.mini_labelframe.grid(row=spring_onions_row, column=spring_onions_placement)

# Current toppings for Chicken Supreme
spring_onions_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Spring_onion.png","Spring\nOnions\n\n",
remove_spring_onions, 1,0)

# spring_onions cheese to add_on toppings
spring_onions_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Spring_onion.png"
,"Spring\nOnions\n\n", 4,6, spring_onions_becomes_current)
spring_onions_add_on.topping_button['state'] = DISABLED
spring_onions_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Chicken_Supreme_PAGE import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Tomato_capsicum_sauce