...
def add_delivery_to_order_list():
    ...
    if combined_name_as_one.isalpha() == True:
        ...
        if name_length <= 1:
            ...
            name_entry_box.warning.configure(text='Not a proper Full Name.')
            return 'break'
        elif name_length > 26:
            name_entry_box.warning.grid(row=2, column=0, sticky=W, padx=2)
            name_entry_box.title_of_requirment_outside.configure(foreground='red')
            name_entry_box.warning.configure(text='Full Name should be less then 26 Letters.')
            return 'break'
        elif name_length > 1:
            pass
    ...
    if phone_number_entry_box.entry_box.get().isnumeric() == True:
        ...
        if phone_number_length < 10 or phone_number_length > 10:
            ...
            phone_number_entry_box.warning.configure(text='Requires 10 digits and only digits allowed.')
            return 'break'
    ...
    if unit_entry_box.entry_box.get().isnumeric() == True:
        ...
        if unit_length <= 0:
            ...
            unit_entry_box.warning.configure(text='Not a proper Unit Number.')
            return "break"
        elif unit_length > 9:
            unit_entry_box.warning.grid(row=2, column=0, sticky=W, padx=2)
            unit_entry_box.title_of_requirment_outside.configure(foreground='red')
            unit_entry_box.warning.configure(text='Exceeded the max limited for Unit Number.')
            return "break"
        elif unit_length > 0:
            pass
    ...
    if street_entry_box.entry_box.get().isnumeric() == True:
        ...
        if street_number_length <= 0:
            ...
            street_entry_box.warning.configure(text='Not a proper Street Number.')
            return "break"
        elif street_number_length > 9:
            street_entry_box.warning.grid(row=2, column=0, sticky=W, padx=2)
            street_entry_box.title_of_requirment_outside.configure(foreground='red')
            street_entry_box.warning.configure(text='Not a proper Street Number.')
            return "break"
    ...
    if combined_street_name_as_one.isalpha() == True:
        ...
        if street_name_length <= 1:
            ...
            street_name_entry_box.warning.configure(text='Not a proper Street Name.')
            return 'break'
    ...
    if combined_suburb_name_as_one.isalpha() == True:
        ...
        if suburb_name_length <= 1:
            ...
            suburb_name_entry_box.warning.configure(text='Not a proper Suburb Name.')
            return 'break'
    ...
    # Chaning the length of the street name and town name so it doesn't get big:
    street_name = street_name_entry_box.entry_box.get()
    street_name_length = len(street_name)
    if street_name_length > 26:
        new_shorter_street_name = f"{street_name[:8]}.."
    else:
        new_shorter_street_name = street_name

    # Chaning the length of the town name and town name so it doesn't get big:
    town_name = suburb_name_entry_box.entry_box.get()
    town_name_length = len(town_name)
    if town_name_length > 26:
        new_shorter_town_name = f"{town_name[:8]}.."
    else:
        new_shorter_town_name = town_name

    address_display_label.configure(text=f"Address: {unit_entry_box.entry_box.get()}/{street_entry_box.entry_box.get()} {new_shorter_street_name.title()} {new_shorter_town_name.title()} {postcode_entry_box.entry_box.get()}")
    # delivery time display
...
# Time and date updates from real time this for delivery
def timer_set():
    hours = t.localtime()
    minutes = t.gmtime()
...
phone_number_entry_box = Entry_generator(mini_delivery_frame,'e.g: 6412342423: (Max 10#)', 0, 1, 1, "Requires 10 digits or have gaps.", "Phone Number")
...
def error_phone(e):
    ...
    if phone_number_entry_box_length < 0:
        phone_number_entry_box.title_of_requirment_outside.configure(foreground='red')
    elif phone_number_entry_box_length >= 0 and phone_number_entry_box_length < 10:
        ...
        if "" in in_list_phone:
            ...
            return 'break'
    elif phone_number_entry_box_length > 10:
        phone_number_entry_box.title_of_requirment_outside.configure(foreground='red')
        phone_number_entry_box.warning.grid(row=2,column=0, sticky=W, padx=2)
        phone_number_entry_box.warning.configure(text = "Requires 10 digits or have gaps.")
...
def error_removing_phone(e):
    ...
    try:
        ...
        if phone_number_entry_box_length <= -1:
            return "break"
        elif phone_number_entry_box_length >= 0 and phone_number_entry_box_length < 13:
            phone_number_entry_box.title_of_requirment_outside.configure(foreground='blue')
            phone_number_entry_box.warning.grid_forget()
        elif phone_number_entry_box_length > 12:
            phone_number_entry_box.title_of_requirment_outside.configure(foreground='red')
            phone_number_entry_box.warning.grid(row=2,column=0, sticky=W, padx=2)
...
# All the unit entry box detail here
street_name_entry_box = Entry_generator(mini_delivery_frame,'e.g: Bruce Mclaren', 2, 0, 2, "","Street Name")
...
# All the unit entry box detail here
suburb_name_entry_box = Entry_generator(mini_delivery_frame,'e.g: New Lynn', 3, 0, 1, "","Suburb")
...
def add_pickup_details():
    ...
    if combined_name_as_one.isalpha() == True:
        ...
        if name_length <= 1:
            ...
            name_entry_box_pickup.warning.configure(text='Not a proper Full Name.')
            return 'break'
        elif name_length > 26:
            name_entry_box.warning.grid(row=2, column=0, sticky=W, padx=2)
            name_entry_box.title_of_requirment_outside.configure(foreground='red')
    ...
    if phone_number_entry_box_pickup.entry_box.get().isnumeric() == True:
        ...
        if phone_number_length < 10 or phone_number_length > 10:
            ...
            phone_number_entry_box_pickup.warning.configure(text='Requires 10 digits and only digits allowed.')
            return 'break'
...
# Phone number entry box and all the error telling detail
phone_number_entry_box_pickup = Entry_generator(mini_pickup_frame,'e.g: 6412342423: (Max 10#)', 0, 1, 1, "Requires 10 digits or have gaps.", "Phone Number")
...
def error_phone(e):
    ...
    if phone_number_entry_box_length < 0:
        ...
        phone_number_entry_box_pickup.title_of_requirment_outside.configure(foreground='red')
        phone_number_entry_box_pickup.warning.grid(row=2,column=0, sticky=W, padx=2)
        phone_number_entry_box_pickup.warning.configure(text = "Requires 10 digits or have gaps.")
