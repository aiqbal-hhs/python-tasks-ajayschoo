...
# Removing gralic_base_sauce_swirl cheese from current topping list if want to
def remove_gralic_base_sauce_swirl():
    gralic_base_sauce_swirl_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Gralic Base Sauce Swirl")
    gralic_base_sauce_swirl_add_on.topping_button['state'] = NORMAL
    gralic_base_sauce_swirl_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting gralic_base_sauce_swirl cheese into current topping
def gralic_base_sauce_swirl_becomes_current():
    global gralic_base_sauce_swirl_current
    intro_pages.storing_current_toppings.append('Gralic Base Sauce Swirl')
    gralic_base_sauce_swirl_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Gralic Bass suace swirl.png",
    "Gralic Base\nSauce\nSwirl\n", remove_gralic_base_sauce_swirl,0,0)
    gralic_base_sauce_swirl_add_on.topping_button['state'] = DISABLED
    gralic_base_sauce_swirl_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    gralic_base_sauce_swirl_current.mini_labelframe.grid(row=gralic_base_sauce_swirl_row, column=gralic_base_sauce_swirl_placement)

# Current toppings for simply cheese
gralic_base_sauce_swirl_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Gralic Bass suace swirl.png","Gralic Base\nSauce\nSwirl\n",
remove_gralic_base_sauce_swirl, 3,0)

# gralic_base_sauce_swirl cheese to add_on toppings
gralic_base_sauce_swirl_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Gralic Bass suace swirl.png"
,"Gralic Base\nSauce\nSwirl\n", 2,2, gralic_base_sauce_swirl_becomes_current)
gralic_base_sauce_swirl_add_on.topping_button['state'] = DISABLED
gralic_base_sauce_swirl_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Gralic_Prawns_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
