...
# Removing oregano cheese from current topping list if want to
def remove_oregano():
    oregano_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Oregano")
    oregano_add_on.topping_button['state'] = NORMAL
    oregano_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting oregano cheese into current topping
def oregano_becomes_current():
    global oregano_current
    intro_pages.storing_current_toppings.append('Oregano')
    oregano_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\oregano.png",
    "Oregano\n\n\n", remove_oregano,0,0)
    oregano_add_on.topping_button['state'] = DISABLED
    oregano_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    oregano_current.mini_labelframe.grid(row=oregano_row, column=oregano_placement)

# Current toppings for simply cheese
oregano_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\oregano.png","Oregano\n\n\n",
remove_oregano, 4,0)

# oregano cheese to add_on toppings
oregano_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\oregano.png"
,"Oregano\n\n\n", 3,4, oregano_becomes_current)
oregano_add_on.topping_button['state'] = DISABLED
oregano_add_on.add_on_topping_name.configure(fg = '#DADADA')
...
from Gralic_Prawns_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce