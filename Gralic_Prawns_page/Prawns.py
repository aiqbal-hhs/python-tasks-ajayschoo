...
# Removing prawns cheese from current topping list if want to
def remove_prawns():
    prawns_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Prawns")
    prawns_add_on.topping_button['state'] = NORMAL
    prawns_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting prawns cheese into current topping
def prawns_becomes_current():
    global prawns_current
    intro_pages.storing_current_toppings.append('Prawns')
    prawns_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Prawns.png",
    "Prawns\n\n\n", remove_prawns,0,0)
    prawns_add_on.topping_button['state'] = DISABLED
    prawns_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    prawns_current.mini_labelframe.grid(row=prawns_row, column=prawns_placement)

# Current toppings for simply cheese
prawns_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Prawns.png","Prawns\n\n\n",
remove_prawns, 5,0)

# prawns cheese to add_on toppings
prawns_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Prawns.png"
,"Prawns\n\n\n", 4,2, prawns_becomes_current)
prawns_add_on.topping_button['state'] = DISABLED
prawns_add_on.add_on_topping_name.configure(fg = '#DADADA')
...
from Gralic_Prawns_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce