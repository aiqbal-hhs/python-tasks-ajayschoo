...
storing_current_toppings = ['Mozzarella Cheese', 'Baby Spinach', 'Fresh Tomatos', 'Gralic Base Sauce Swirl', 'Oregano', 'Prawns']
...
topping_background_frame = Frame(expanding_pages.gralic_prawn_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
