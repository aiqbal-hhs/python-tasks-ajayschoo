...
from Ham_and_cheese_page import ham_and_cheese_intro_labelframes as intro_pages


# Removing cherry_wood_somked_leg_ham cheese from current topping list if want to
def remove_cherry_wood_somked_leg_ham():
    cherry_wood_somked_leg_ham_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Cherry wood somked leg ham")
    cherry_wood_somked_leg_ham_add_on.topping_button['state'] = NORMAL
    cherry_wood_somked_leg_ham_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
    ...
    if len(intro_pages.storing_current_toppings) < 10:
        ...
        Gralic_Parmesan_Sauce.gralic_permesan_sauce_add_on.topping_button['state'] = NORMAL
        Gralic_Parmesan_Sauce.gralic_permesan_sauce_add_on.add_on_topping_name.configure(fg='black')
    ...
    # Adjusting the position of other topping if this topping shas been deleted
    ...
    if "Frank RedHot Original Hot Sauce" in intro_pages.storing_current_toppings:
        frank_redhot_original_hot_sauce_placement = intro_pages.storing_current_toppings.index('Frank RedHot Original Hot Sauce')
    ...
    if "Gralic Base Sauce Swirl" in intro_pages.storing_current_toppings:
        ...
        pass
    if "Gralic Permesan Sauce" in intro_pages.storing_current_toppings:
        ...
        Gralic_Parmesan_Sauce.gralic_permesan_sauce_current.mini_labelframe.grid(row=gralic_permesan_sauce_row,column=gralic_permesan_sauce_placement)
    else:
        pass
    ...
    if "Gralic Permesan Sauce" in intro_pages.storing_current_toppings:
        Gralic_Parmesan_Sauce.gralic_permesan_sauce_add_on.topping_button['state'] = DISABLED
        Gralic_Parmesan_Sauce.gralic_permesan_sauce_add_on.add_on_topping_name.configure(fg='#DADADA')
    if "Ground Beef" in intro_pages.storing_current_toppings:
...
# Converting cherry_wood_somked_leg_ham cheese into current topping
def cherry_wood_somked_leg_ham_becomes_current():
    global cherry_wood_somked_leg_ham_current
    intro_pages.storing_current_toppings.append('Cherry wood somked leg ham')
    cherry_wood_somked_leg_ham_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Cherry wood somked leg ham.png",
    "Cherry wood\nsomked leg\nham\n", remove_cherry_wood_somked_leg_ham, 0,0)
    cherry_wood_somked_leg_ham_add_on.topping_button['state'] = DISABLED
    cherry_wood_somked_leg_ham_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    cherry_wood_somked_leg_ham_current.mini_labelframe.grid(row=cherry_wood_somked_leg_ham_row, column=cherry_wood_somked_leg_ham_placement)

# Current toppings for simply cheese
cherry_wood_somked_leg_ham_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Cherry wood somked leg ham.png","Cherry wood\nsomked leg\nham\n",
remove_cherry_wood_somked_leg_ham, 1,0)

# cherry_wood_somked_leg_ham cheese to add_on toppings
cherry_wood_somked_leg_ham_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Cherry wood somked leg ham.png"
,"Cherry wood\nsomked leg\nham\n", 1,5, cherry_wood_somked_leg_ham_becomes_current)
cherry_wood_somked_leg_ham_add_on.topping_button['state'] = DISABLED
cherry_wood_somked_leg_ham_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Ham_and_cheese_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
