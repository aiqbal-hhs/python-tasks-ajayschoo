...
storing_current_toppings = ['Mozzarella Cheese', 'Cherry wood somked leg ham']
...
topping_background_frame = Frame(expanding_pages.ham_cheese_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
