...
from Mega_MeatLover_page import Anchovies, Baby_spinach, Camembert_Cheese, Cherry_wood_somked_leg_ham, Chili_Flakes,  Mozzarella_topping, Paneer_Cheese, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
