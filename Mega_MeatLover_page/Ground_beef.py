...
# Removing ground_beef cheese from current topping list if want to
def remove_ground_beef():
    ground_beef_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Ground Beef")
    ground_beef_add_on.topping_button['state'] = NORMAL
    ground_beef_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting ground_beef cheese into current topping
def ground_beef_becomes_current():
    global ground_beef_current
    intro_pages.storing_current_toppings.append('Ground Beef')
    ground_beef_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Ground Beef.png",
    "Ground\nBeef\n\n", remove_ground_beef,0,0)
    ground_beef_add_on.topping_button['state'] = DISABLED
    ground_beef_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    ground_beef_current.mini_labelframe.grid(row=ground_beef_row, column=ground_beef_placement)

# Current toppings for simply cheese
ground_beef_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Ground Beef.png","Ground\nBeef\n\n",
remove_ground_beef, 2,0)

# ground_beef cheese to add_on toppings
ground_beef_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Ground Beef.png"
,"Ground\nBeef\n\n", 2,4, ground_beef_becomes_current)
ground_beef_add_on.topping_button['state'] = DISABLED
ground_beef_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Mega_MeatLover_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Hickory_BBQ_Sauce,\
