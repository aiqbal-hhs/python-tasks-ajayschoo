...
# Removing hickory_bbq_sauce cheese from current topping list if want to
def remove_hickory_bbq_sauce():
    hickory_bbq_sauce_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Hickory BBQ Sauce")
    hickory_bbq_sauce_add_on.topping_button['state'] = NORMAL
    hickory_bbq_sauce_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting hickory_bbq_sauce cheese into current topping
def hickory_bbq_sauce_becomes_current():
    global hickory_bbq_sauce_current
    intro_pages.storing_current_toppings.append('Hickory BBQ Sauce')
    hickory_bbq_sauce_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Hickory BBQ sauce Swirl.png",
    "Hickory BBQ\nSauce\n\n", remove_hickory_bbq_sauce,0,0)
    hickory_bbq_sauce_add_on.topping_button['state'] = DISABLED
    hickory_bbq_sauce_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    hickory_bbq_sauce_current.mini_labelframe.grid(row=hickory_bbq_sauce_row, column=hickory_bbq_sauce_placement)

# Current toppings for simply cheese
hickory_bbq_sauce_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Hickory BBQ sauce Swirl.png","Hickory BBQ\nSauce\n\n",
remove_hickory_bbq_sauce, 3,0)

# hickory_bbq_sauce cheese to add_on toppings
hickory_bbq_sauce_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Hickory BBQ sauce Swirl.png"
,"Hickory BBQ\nSauce\n\n", 2,5, hickory_bbq_sauce_becomes_current)
hickory_bbq_sauce_add_on.topping_button['state'] = DISABLED
hickory_bbq_sauce_add_on.add_on_topping_name.configure(fg = '#DADADA')
