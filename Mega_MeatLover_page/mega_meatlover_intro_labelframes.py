...
storing_current_toppings = ['Mozzarella Cheese', 'Cherry wood somked leg ham', 'Ground Beef', 'Hickory BBQ Sauce', 'Pepperoni', 'Rasher Bacon', 'Seasoned Chicken']
...
topping_background_frame = Frame(expanding_pages.mega_meatlover_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
