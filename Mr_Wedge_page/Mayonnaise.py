...
# Removing mayonnaise cheese from current topping list if want to
def remove_mayonnaise():
    mayonnaise_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Mayonnaise")
    mayonnaise_add_on.topping_button['state'] = NORMAL
    mayonnaise_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting mayonnaise cheese into current topping
def mayonnaise_becomes_current():
    global mayonnaise_current
    intro_pages.storing_current_toppings.append('Mayonnaise')
    mayonnaise_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Mayonnaise.png",
    "Mayonnaise\n\n\n", remove_mayonnaise,0,0)
    mayonnaise_add_on.topping_button['state'] = DISABLED
    mayonnaise_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    mayonnaise_current.mini_labelframe.grid(row=mayonnaise_row, column=mayonnaise_placement)

# Current toppings for simply cheese
mayonnaise_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Mayonnaise.png","Mayonnaise\n\n\n",
remove_mayonnaise, 3,0)

# mayonnaise cheese to add_on toppings
mayonnaise_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Mayonnaise.png"
,"Mayonnaise\n\n\n", 3,0, mayonnaise_becomes_current)
mayonnaise_add_on.topping_button['state'] = DISABLED
mayonnaise_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Mr_Wedge_page import Mozzarella_topping, Paneer_Cheese, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
    Anchovies, Hollandaise_sauce_swirl, Jalapenos, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce