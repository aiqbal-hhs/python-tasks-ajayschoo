...
storing_current_toppings = ['Mozzarella Cheese', 'Gralic Base Sauce Swirl', 'Cherry wood somked leg ham', 'Mayonnaise', 'Red Onions', 'Oregano']
...
topping_background_frame = Frame(expanding_pages.mr_wedge_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
