...
# Removing anchovies cheese from current topping list if want to
def remove_anchovies():
    anchovies_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Anchovies")
    anchovies_add_on.topping_button['state'] = NORMAL
    anchovies_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting anchovies cheese into current topping
def anchovies_becomes_current():
    global anchovies_current
    intro_pages.storing_current_toppings.append('Anchovies')
    anchovies_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Anchovies.png",
    "Anchovies\n\n\n", remove_anchovies, 0,0)
    anchovies_add_on.topping_button['state'] = DISABLED
    anchovies_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    anchovies_current.mini_labelframe.grid(row=anchovies_row, column=anchovies_placement)


# anchovies cheese to add_on toppings
anchovies_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Anchovies.png"
,"Anchovies\n\n\n", 1,0, anchovies_becomes_current)


# Importing all other toppings
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
