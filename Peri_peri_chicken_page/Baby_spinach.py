...
# Removing baby_spinach cheese from current topping list if want to
def remove_baby_spinach():
    baby_spinach_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Baby Spinach")
    baby_spinach_add_on.topping_button['state'] = NORMAL
    baby_spinach_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting baby_spinach cheese into current topping
def baby_spinach_becomes_current():
    global baby_spinach_current
    intro_pages.storing_current_toppings.append('Baby Spinach')
    baby_spinach_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Baby spinach.png",
    "Baby\nSpinach\n\n", remove_baby_spinach, 0,0)
    baby_spinach_add_on.topping_button['state'] = DISABLED
    baby_spinach_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    baby_spinach_current.mini_labelframe.grid(row=baby_spinach_row, column=baby_spinach_placement)

# Current toppings for simply cheese
baby_spinach_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Baby spinach.png","Baby\nSpinach\n\n",
remove_baby_spinach, 1,0)

# baby_spinach cheese to add_on toppings
baby_spinach_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Baby spinach.png"
,"Baby\nSpinach\n\n", 1,1, baby_spinach_becomes_current)
baby_spinach_add_on.topping_button['state'] = DISABLED
baby_spinach_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
