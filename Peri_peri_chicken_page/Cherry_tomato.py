...
# Removing cherry_tomatos cheese from current topping list if want to
def remove_cherry_tomatos():
    cherry_tomatos_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Cherry Tomatos")
    cherry_tomatos_add_on.topping_button['state'] = NORMAL
    cherry_tomatos_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting cherry_tomatos cheese into current topping
def cherry_tomatos_becomes_current():
    global cherry_tomatos_current
    intro_pages.storing_current_toppings.append('Cherry Tomatos')
    cherry_tomatos_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Cherry Tomato.png",
    "Cherry\nTomatos\n\n", remove_cherry_tomatos, 0,0)
    cherry_tomatos_add_on.topping_button['state'] = DISABLED
    cherry_tomatos_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    cherry_tomatos_current.mini_labelframe.grid(row=cherry_tomatos_row, column=cherry_tomatos_placement)


# cherry_tomatos cheese to add_on toppings
cherry_tomatos_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Cherry Tomato.png"
,"Cherry\nTomatos\n\n", 1,4, cherry_tomatos_becomes_current)


# Importing all other toppings
from Peri_peri_chicken_page import Anchovies, Baby_spinach, Camembert_Cheese, Cherry_wood_somked_leg_ham, Chili_Flakes,  Mozzarella_topping, Paneer_Cheese, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
