...
# Removing chili_flakes cheese from current topping list if want to
def remove_chili_flakes():
    chili_flakes_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Chili Flakes")
    chili_flakes_add_on.topping_button['state'] = NORMAL
    chili_flakes_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting chili_flakes cheese into current topping
def chili_flakes_becomes_current():
    global chili_flakes_current
    intro_pages.storing_current_toppings.append('Chili Flakes')
    chili_flakes_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Chilli Flakes.png",
    "Chili Flakes\n\n\n", remove_chili_flakes,0,0)
    chili_flakes_add_on.topping_button['state'] = DISABLED
    chili_flakes_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    chili_flakes_current.mini_labelframe.grid(row=chili_flakes_row, column=chili_flakes_placement)


# chili_flakes cheese to add_on toppings
chili_flakes_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Chilli Flakes.png"
,"Chili Flakes\n\n\n", 1,6, chili_flakes_becomes_current)


# Importing all other toppings
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
