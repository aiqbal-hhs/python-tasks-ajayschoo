...
# Removing feta cheese from current topping list if want to
def remove_feta():
    feta_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Feta")
    feta_add_on.topping_button['state'] = NORMAL
    feta_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting feta cheese into current topping
def feta_becomes_current():
    global feta_current
    intro_pages.storing_current_toppings.append('Feta')
    feta_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Feta.png",
    "feta\n\n\n", remove_feta,0,0)
    feta_add_on.topping_button['state'] = DISABLED
    feta_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    feta_current.mini_labelframe.grid(row=feta_row, column=feta_placement)


# feta cheese to add_on toppings
feta_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Feta.png"
,"feta\n\n\n", 1,7, feta_becomes_current)


# Importing all other toppings
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
