...
# Removing frank_redhot_original_hot_sauce cheese from current topping list if want to
def remove_frank_redhot_original_hot_sauce():
    frank_redhot_original_hot_sauce_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Frank RedHot Original Hot Sauce")
    frank_redhot_original_hot_sauce_add_on.topping_button['state'] = NORMAL
    frank_redhot_original_hot_sauce_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting frank_redhot_original_hot_sauce cheese into current topping
def frank_redhot_original_hot_sauce_becomes_current():
    global frank_redhot_original_hot_sauce_current
    intro_pages.storing_current_toppings.append('Frank RedHot Original Hot Sauce')
    frank_redhot_original_hot_sauce_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Franks RadHot Orginal Hot Sauce.png",
    "Frank Red\nHot Original\nSauce\n", remove_frank_redhot_original_hot_sauce,0,0)
    frank_redhot_original_hot_sauce_add_on.topping_button['state'] = DISABLED
    frank_redhot_original_hot_sauce_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    frank_redhot_original_hot_sauce_current.mini_labelframe.grid(row=frank_redhot_original_hot_sauce_row, column=frank_redhot_original_hot_sauce_placement)


# frank_redhot_original_hot_sauce cheese to add_on toppings
frank_redhot_original_hot_sauce_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Franks RadHot Orginal Hot Sauce.png"
,"Frank Red\nHot Original\nSauce\n", 2,0, frank_redhot_original_hot_sauce_becomes_current)


# Importing all other toppings
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
