...
# Removing fresh_tomatos cheese from current topping list if want to
def remove_fresh_tomatos():
    fresh_tomatos_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Fresh Tomatos")
    fresh_tomatos_add_on.topping_button['state'] = NORMAL
    fresh_tomatos_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting fresh_tomatos cheese into current topping
def fresh_tomatos_becomes_current():
    global fresh_tomatos_current
    intro_pages.storing_current_toppings.append('Fresh Tomatos')
    fresh_tomatos_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Fresh tomato.png",
    "Fresh\nTomatos\n\n", remove_fresh_tomatos,0,0)
    fresh_tomatos_add_on.topping_button['state'] = DISABLED
    fresh_tomatos_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    fresh_tomatos_current.mini_labelframe.grid(row=fresh_tomatos_row, column=fresh_tomatos_placement)

# Current toppings for simply cheese
fresh_tomatos_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Fresh tomato.png","Fresh\nTomatos\n\n",
remove_fresh_tomatos, 2,0)

# fresh_tomatos cheese to add_on toppings
fresh_tomatos_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Fresh tomato.png"
,"Fresh\nTomatos\n\n", 2,1, fresh_tomatos_becomes_current)
fresh_tomatos_add_on.topping_button['state'] = DISABLED
fresh_tomatos_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
