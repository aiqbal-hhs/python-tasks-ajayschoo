...
# Removing jalapenos cheese from current topping list if want to
def remove_jalapenos():
    jalapenos_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Jalapenos")
    jalapenos_add_on.topping_button['state'] = NORMAL
    jalapenos_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting jalapenos cheese into current topping
def jalapenos_becomes_current():
    global jalapenos_current
    intro_pages.storing_current_toppings.append('Jalapenos')
    jalapenos_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Jalapenos.png",
    "Jalapenos\n\n\n", remove_jalapenos,0,0)
    jalapenos_add_on.topping_button['state'] = DISABLED
    jalapenos_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    jalapenos_current.mini_labelframe.grid(row=jalapenos_row, column=jalapenos_placement)


# jalapenos cheese to add_on toppings
jalapenos_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Jalapenos.png"
,"Jalapenos\n\n\n", 2,7, jalapenos_becomes_current)
...
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
    Anchovies, Hollandaise_sauce_swirl, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce