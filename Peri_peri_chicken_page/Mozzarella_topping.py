...
# Removeing mozzarella from current topping if want to
def remove_mozzarella():
    mozzarella_cheese_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Mozzarella Cheese")
    mozzarella_cheese_add_on.topping_button['state'] = NORMAL
    mozzarella_cheese_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
    ...
    if "Frank RedHot Original Hot Sauce" in intro_pages.storing_current_toppings:
        ...
        Franks_RedHot_Orginal_Hot_Sauce.frank_redhot_original_hot_sauce_current.mini_labelframe.grid(
            row=frank_redhot_original_hot_sauce_row, column=frank_redhot_original_hot_sauce_placement)
    else:
        pass
...
# adding mozzarella to current if not have been added
def mozzarella_becomes_current():
    global mozzarella_cheese_current
    intro_pages.storing_current_toppings.append("Mozzarella Cheese")
    mozzarella_cheese_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Mozzarella Cheese.png","Mozzarella\nCheese\n\n",remove_mozzarella, 0, 0)
    mozzarella_cheese_add_on.topping_button['state'] = DISABLED
    mozzarella_cheese_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    mozzarella_cheese_current.mini_labelframe.grid(row= row_of_mozzarella, column= mozzarella_placement)
...
# Add on toppings for simply cheese page (mozzarella cheese)
mozzarella_cheese_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Mozzarella Cheese.png","Mozzarella\nCheese\n\n",3,1, mozzarella_becomes_current)
mozzarella_cheese_add_on.topping_button['state'] = DISABLED
mozzarella_cheese_add_on.add_on_topping_name.configure(fg = '#DADADA')


# Importing all other toppings
from Peri_peri_chicken_page import Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
