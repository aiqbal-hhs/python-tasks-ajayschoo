...
# Removing olives cheese from current topping list if want to
def remove_olives():
    olives_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Olives")
    olives_add_on.topping_button['state'] = NORMAL
    olives_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting olives cheese into current topping
def olives_becomes_current():
    global olives_current
    intro_pages.storing_current_toppings.append('Olives')
    olives_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\olives.png",
    "Olives\n\n\n", remove_olives,0,0)
    olives_add_on.topping_button['state'] = DISABLED
    olives_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    olives_current.mini_labelframe.grid(row=olives_row, column=olives_placement)


# olives cheese to add_on toppings
olives_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\olives.png"
,"Olives\n\n\n", 3,3, olives_becomes_current)
...
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce