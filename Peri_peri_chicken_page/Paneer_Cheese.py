...
# Removing paneer cheese from current topping list if want to
def remove_paneer_cheese():
    paneer_cheese_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Paneer Cheese")
    paneer_cheese_add_on.topping_button['state'] = NORMAL
    paneer_cheese_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting paneer cheese into current topping
def paneer_becomes_current():
    global paneer_cheese_current
    intro_pages.storing_current_toppings.append('Paneer Cheese')
    paneer_cheese_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\PaneerCheese.png",
    "Paneer\nCheese\n\n", remove_paneer_cheese,0,0)
    paneer_cheese_add_on.topping_button['state'] = DISABLED
    paneer_cheese_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    paneer_cheese_current.mini_labelframe.grid(row=paneer_row, column=paneer_cheese_placement)


# paneer cheese to add_on toppings
paneer_cheese_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\PaneerCheese.png"
,"Paneer\nCheese\n\n", 3,5, paneer_becomes_current)


# Importing all other toppings
from Peri_peri_chicken_page import Mozzarella_topping, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef, Hickory_BBQ_Sauce,\
