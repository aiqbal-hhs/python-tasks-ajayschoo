...
from Peri_peri_chicken_page import peri_peri_chicken_intro_labelframes as intro_pages


# Removing peri_peri_sauce_swirl cheese from current topping list if want to
def remove_peri_peri_sauce_swirl():
    peri_peri_sauce_swirl_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Peri Peri Sauce Swirl")
    peri_peri_sauce_swirl_add_on.topping_button['state'] = NORMAL
    peri_peri_sauce_swirl_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting peri_peri_sauce_swirl cheese into current topping
def peri_peri_sauce_swirl_becomes_current():
    global peri_peri_sauce_swirl_current
    intro_pages.storing_current_toppings.append('Peri Peri Sauce Swirl')
    peri_peri_sauce_swirl_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Peri_peri sauce swirl.png",
    "Peri Peri\nSauce\nSwirl\n", remove_peri_peri_sauce_swirl,0,0)
    peri_peri_sauce_swirl_add_on.topping_button['state'] = DISABLED
    peri_peri_sauce_swirl_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    peri_peri_sauce_swirl_current.mini_labelframe.grid(row=peri_peri_sauce_swirl_row, column=peri_peri_sauce_swirl_placement)

# Current toppings for simply cheese
peri_peri_sauce_swirl_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Peri_peri sauce swirl.png","Peri Peri\nSauce\nswirl\n",
remove_peri_peri_sauce_swirl, 3,0)

# peri_peri_sauce_swirl cheese to add_on toppings
peri_peri_sauce_swirl_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Peri_peri sauce swirl.png"
,"Peri Peri\nSauce\nswirl\n", 3,7, peri_peri_sauce_swirl_becomes_current)
peri_peri_sauce_swirl_add_on.topping_button['state'] = DISABLED
peri_peri_sauce_swirl_add_on.add_on_topping_name.configure(fg = '#DADADA')

# Importing all other toppings
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce