...
# Removing planet_based_beef cheese from current topping list if want to
def remove_planet_based_beef():
    planet_based_beef_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Planet Based Beef")
    planet_based_beef_add_on.topping_button['state'] = NORMAL
    planet_based_beef_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting planet_based_beef cheese into current topping
def planet_based_beef_becomes_current():
    global planet_based_beef_current
    intro_pages.storing_current_toppings.append('Planet Based Beef')
    planet_based_beef_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Planet_Based_Beef.png",
    "Planet\nBased\nBeef\n", remove_planet_based_beef,0,0)
    planet_based_beef_add_on.topping_button['state'] = DISABLED
    planet_based_beef_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    planet_based_beef_current.mini_labelframe.grid(row=planet_based_beef_row, column=planet_based_beef_placement)


# planet_based_beef cheese to add_on toppings
planet_based_beef_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Planet_Based_Beef.png"
,"Planet\nBased\nBeef\n", 4,1, planet_based_beef_becomes_current)
...
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce