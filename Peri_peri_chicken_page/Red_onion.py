...
# Removing red_onions cheese from current topping list if want to
def remove_red_onions():
    red_onions_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Red Onions")
    red_onions_add_on.topping_button['state'] = NORMAL
    red_onions_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting red_onions cheese into current topping
def red_onions_becomes_current():
    global red_onions_current
    intro_pages.storing_current_toppings.append('Red Onions')
    red_onions_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\red_onion.png",
    "Red Onions\n\n\n", remove_red_onions,0,0)
    red_onions_add_on.topping_button['state'] = DISABLED
    red_onions_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    red_onions_current.mini_labelframe.grid(row=red_onions_row, column=red_onions_placement)

# Current toppings for simply cheese
red_onions_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\red_onion.png","Red Onions\n\n\n",
remove_red_onions, 4,0)

# red_onions cheese to add_on toppings
red_onions_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\red_onion.png"
,"Red Onions\n\n\n", 4,4, red_onions_becomes_current)
red_onions_add_on.topping_button['state'] = DISABLED
red_onions_add_on.add_on_topping_name.configure(fg = '#DADADA')
...
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Seasoned_Chicken, Spring_Onion, Tomato_capsicum_sauce