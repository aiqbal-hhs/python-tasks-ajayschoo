...
# Removing seasoned_chicken cheese from current topping list if want to
def remove_seasoned_chicken():
    seasoned_chicken_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Seasoned Chicken")
    seasoned_chicken_add_on.topping_button['state'] = NORMAL
    seasoned_chicken_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting seasoned_chicken cheese into current topping
def seasoned_chicken_becomes_current():
    global seasoned_chicken_current
    intro_pages.storing_current_toppings.append('Seasoned Chicken')
    seasoned_chicken_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Season_chicken.png",
    "Seasoned\nChicken\n\n", remove_seasoned_chicken,0,0)
    seasoned_chicken_add_on.topping_button['state'] = DISABLED
    seasoned_chicken_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    seasoned_chicken_current.mini_labelframe.grid(row=seasoned_chicken_row, column=seasoned_chicken_placement)

# Current toppings for simply cheese
seasoned_chicken_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only,r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Season_chicken.png","Seasoned\nChicken\n\n",
remove_seasoned_chicken, 5,0)

# seasoned_chicken cheese to add_on toppings
seasoned_chicken_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\Season_chicken.png"
,"Seasoned\nChicken\n\n", 4,5, seasoned_chicken_becomes_current)
seasoned_chicken_add_on.topping_button['state'] = DISABLED
seasoned_chicken_add_on.add_on_topping_name.configure(fg = '#DADADA')
...
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Spring_Onion, Tomato_capsicum_sauce