...
# Removing tomato_capsicum_sauce cheese from current topping list if want to
def remove_tomato_capsicum_sauce():
    tomato_capsicum_sauce_current.mini_labelframe.destroy()
    intro_pages.storing_current_toppings.remove("Tomato Capsicum Sauce")
    tomato_capsicum_sauce_add_on.topping_button['state'] = NORMAL
    tomato_capsicum_sauce_add_on.add_on_topping_name.configure(fg = 'black')
    intro_pages.reszing()
...
# Converting tomato_capsicum_sauce cheese into current topping
def tomato_capsicum_sauce_becomes_current():
    global tomato_capsicum_sauce_current
    intro_pages.storing_current_toppings.append('Tomato Capsicum Sauce')
    tomato_capsicum_sauce_current = expanding_pages.Current_topping_generator(intro_pages.current_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\tomato_capsicum_sauce_swirl.png",
    "Tomato\nCapsicum\nSauce\n", remove_tomato_capsicum_sauce,0,0)
    tomato_capsicum_sauce_add_on.topping_button['state'] = DISABLED
    tomato_capsicum_sauce_add_on.add_on_topping_name.configure(fg = '#DADADA')
    ...
    tomato_capsicum_sauce_current.mini_labelframe.grid(row=tomato_capsicum_sauce_row, column=tomato_capsicum_sauce_placement)


# tomato_capsicum_sauce cheese to add_on toppings
tomato_capsicum_sauce_add_on = expanding_pages.Add_on_topping_generator(intro_pages.add_on_topping_labelframe_only, r"C:\Users\ajayb\PycharmProjects\Henderson_Pizza_Palace\Toppings\tomato_capsicum_sauce_swirl.png"
,"Tomato\nCapsicum\nSauce\n", 4,7, tomato_capsicum_sauce_becomes_current)
...
from Peri_peri_chicken_page import Mozzarella_topping, Paneer_Cheese, Anchovies, Baby_spinach, Camembert_Cheese, Cherry_tomato, Cherry_wood_somked_leg_ham, Chili_Flakes, Capasicum, Feta, Franks_RedHot_Orginal_Hot_Sauce, Fresh_Tomatos, Gralic_base_sauce_swirl, Gralic_Parmesan_Sauce, Ground_beef,\
    Hickory_BBQ_Sauce, Hollandaise_sauce_swirl, Jalapenos, Mayonnaise, Mushroom, Olives, Oregano, Pepperoni, Peri_peri_sauce_swirl, Pineapple, Planet_based_Beef, Prawns, Rasher_Bacon, Red_onion, Seasoned_Chicken, Spring_Onion