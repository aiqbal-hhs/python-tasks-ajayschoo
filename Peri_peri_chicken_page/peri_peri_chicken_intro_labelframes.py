...
storing_current_toppings = ['Mozzarella Cheese', 'Baby Spinach', 'Fresh Tomatos', 'Peri Peri Sauce Swirl', 'Red Onions', 'Seasoned Chicken']
...
topping_background_frame = Frame(expanding_pages.peri_peri_chicken_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
