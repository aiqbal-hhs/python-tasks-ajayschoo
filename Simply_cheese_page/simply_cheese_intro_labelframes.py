...
storing_current_toppings = ['Mozzarella Cheese']
...
topping_background_frame = Frame(expanding_pages.simply_cheese_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
