...
storing_current_toppings = ['Mozzarella Cheese', 'Rasher Bacon', 'Ground Beef', 'Capsicum', 'Mushroom', 'Oregano', 'Pepperoni', 'Pineapple', 'Spring Onions']
...
topping_background_frame = Frame(expanding_pages.supreme_page.topping_labelframe,bg='white', highlightcolor='white', highlightthickness=0)
