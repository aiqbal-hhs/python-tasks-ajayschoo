...
def general_info():
    ...
    2: You need one order in Order List to Check Out.
    3: AWT stands for Allowed Topping with no Charge.""", background='white', font=('Georgia', 10))
...
def helper_slide():
    ...
    helper_pop_up.attributes("-topmost", True)
    helper_pop_up.transient()
